...
public class TestScenario {
    ...
    public void test() {
        ...
        bookingsThirdRoom.add(new Booking(0L, LocalDate.of(2019, 5, 8),
        ...
        rooms.add(new Room(1, firstRoom, maintenanceDatesSet, bookingsFirstRoom, (short) 5));
        rooms.add(new Room(2, secondRoom, maintenanceDatesSet, bookingsSecondRoom, (short) 1));
